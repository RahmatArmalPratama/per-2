...
<body>
	<div class="container mt-5 ">
		<center class="mb-5" >
		<img src="https://uinjambi.ac.id/wp-content/uploads/2020/08/cropped-logouinjambi-12.png" width="15%">
		<font color="blue"><h2>FORM PENGISIAN DATA MAHASISWA</h2></font>
		<font><h4>UIN SULTHAN THAHA SAIFUDDIN JAMBI</h4></font>
	</center>
		<hr>
		...
		<a href="cetak.php" class="btn btn-primary mb-2">Cetak</a>
		<table class="table table-bordered mt-4" id="myTable">
			<thead>
				<tr>
					<th scope="col" width="1%">nomor</th>
					<th scope="col" width="10%">NIM</th>
					<th scope="col" width="15%">Nama</th>
					<th scope="col" width="10%">Email</th>
					<th scope="col" width="15%">Jurusan</th>
					<th scope="col" width="10%">Fakultas</th>
				...
				while ($data = mysqli_fetch_array($get_data)) {
					...
					<tr>
						...
						<td>
							...
							<?php }else{ ?>
								<img src="foto/<?php echo $data['gambar']; ?>" style="width:80px;height:80px;">
							<?php } ?>
						</td>
						<td>
